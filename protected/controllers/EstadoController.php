...
class EstadoController extends Controller
{
	...
	{
		echo CHtml::tag('option',array(),CHtml::encode('Seleccione un Estado'),true);
		if(Yii::app()->request->isAjaxRequest  )
		{
			...
			{
				if( $relacion[0]==Estado::BELONGS_TO && isset($_POST[$relacion[2]]) && !empty($_POST[$relacion[2]]) )
				{
			...
			if($bandera)
				$data=CHtml::listData(Estado::model()->findAll($criteria), 'id', 'nombre');
			else
				$data=array();
