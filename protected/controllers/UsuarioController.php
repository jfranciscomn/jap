...
class UsuarioController extends Controller
{
	...
	{
		echo CHtml::tag('option',array(),CHtml::encode('Seleccione un Usuario'),true);
		if(Yii::app()->request->isAjaxRequest  )
		{
			...
			{
				if( $relacion[0]==Usuario::BELONGS_TO && isset($_POST[$relacion[2]]) && !empty($_POST[$relacion[2]]) )
				{
			...
			if($bandera)
				$data=CHtml::listData(Usuario::model()->findAll($criteria), 'id', 'nombre');
			else
				$data=array();
